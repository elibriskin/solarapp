...
def get_solar_data(choice,capacity,losses,solar_type,tilt_angle,azimuth_angle):
    # Query NREL database to get solar irradiation data
    ...
    pv_data = PVWattsV6(system_capacity=capacity, module_type=0, losses=losses, array_type=solar_type, tilt=tilt_angle, azimuth=azimuth_angle, address=choice)
    ...
    return ac_kw, consumption, solar_pct, ghi, dni
